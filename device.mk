...
# Permissions
PRODUCT_COPY_FILES += \
    frameworks/native/data/etc/system/android.hardware.audio.low_latency.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/android.hardware.audio.low_latency.xml \
    frameworks/native/data/etc/system/android.hardware.audio.pro.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/android.hardware.audio.pro.xml \
    ...
    frameworks/native/data/etc/system/android.hardware.telephony.ims.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/android.hardware.telephony.ims.xml \
    ...
    frameworks/native/data/etc/system/android.hardware.vulkan.level-1.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/android.hardware.vulkan.level-1.xml \
    ...
    frameworks/native/data/etc/system/android.hardware.wifi.aware.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/android.hardware.wifi.aware.xml \
    ...
    frameworks/native/data/etc/system/android.hardware.wifi.rtt.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/android.hardware.wifi.rtt.xml \
    ...
    frameworks/native/data/etc/system/android.software.ipsec_tunnels.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/android.software.ipsec_tunnels.xml \
    ...
    frameworks/native/data/etc/system/android.software.verified_boot.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/android.software.verified_boot.xml \
    frameworks/native/data/etc/system/android.software.vulkan.deqp.level.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/android.software.vulkan.deqp.level.xml \
...
# Inherit vendor
$(call inherit-product, vendor/poco/bhima/bhima-vendor.mk)